...
use Kudashevs\RakePhp\Sorters\WordSorter;
...
class WordSorterTest extends TestCase
{
    ...
    public function it_sorts_in_descending_order_by_default(): void
    {
        ...
        $this->assertSame('third', key($sorted));
    }
    ...
    public function it_can_sort_in_descending_order(): void
    {
        ...
        $sorter = new WordSorter(Order::DESC);
    ...
    public function it_can_sort_in_ascending_order(): void
    {
        ...
        $sorter = new WordSorter(Order::ASC);

        $sorted = $sorter->sort($output);

        $this->assertSame('first', key($sorted));
    }
}
